...
export default function GastronomyPage() {
  return (
    <main className="relative min-h-screen bg-slate-50 overflow-x-hidden font-sans">
      <Header />
      
      {/* 1. Hedefimiz ve Hızlı Erişimler */}
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20 pt-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <span className="text-sky-600 font-bold text-sm tracking-wide block mb-2 uppercase">Uygulamalı Bilimler Fakültesi</span>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://www.ozyegin.edu.tr/tr/gastronomi-ve-mutfak-sanatlari" target="_blank" rel="noreferrer" className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl transition-all shadow-[0_0_20px_rgba(37,99,235,0.4)]">
                Gastronomi ve Mutfak Sanatları
              </a>
              <a href="https://www.ozyegin.edu.tr/tr/otel-yoneticiligi" target="_blank" rel="noreferrer" className="px-6 py-3 bg-cyan-600 hover:bg-cyan-500 text-white font-semibold rounded-xl transition-all shadow-[0_0_20px_rgba(8,145,178,0.4)]">
                Otel Yöneticiliği
              </a>
          ...
          <div className="relative h-[400px] w-full rounded-3xl overflow-hidden shadow-2xl">
            <Image src="https://www.ozyegin.edu.tr/sites/default/files/tesis3_2.jpg" alt="Uygulamalı Bilimler" fill className="object-cover" />
          </div>
        </div>
      </section>
      ...
      >
        <div className="bg-gradient-to-r from-emerald-500/10 via-teal-600/10 to-emerald-500/5 border border-emerald-500/20 rounded-3xl p-8 md:p-12 relative overflow-hidden">
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-grow text-center md:text-left">
              ...
              <p className="text-emerald-900/80 text-lg leading-relaxed mb-6">
              ...
              <a href="https://www.ozyegin.edu.tr/tr/uygulamali-bilimler-fakultesi/acpha-akreditasyonu" target="_blank" rel="noreferrer" className="inline-block px-6 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-lg transition-colors shadow-lg shadow-emerald-500/30">
                Daha Fazla Bilgi
              </a>
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-1/3">
            <div className="sticky top-32 text-center lg:text-left">
              ...
              <p className="text-sky-600 font-medium mb-6">Uygulamalı Bilimler Fakültesi Dekan V.</p>
        ...
        >
          ...
          >
            {[
              ...
              { name: "Shangari-La Group", count: 4 },
          ...
          >
            {[
              ...
              >
                ...
                <span className="text-sky-600 font-black text-xl">{uni.count}</span>
              </motion.div>
            ))}
          </motion.div>
        </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="w-full aspect-square md:aspect-[4/3] relative mb-6 mt-2 overflow-hidden">
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="w-full aspect-square md:aspect-[4/3] relative mb-6 mt-16 overflow-hidden bg-slate-100 flex items-center justify-center">
      ...
      <section className="relative z-10 w-full bg-white py-24">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500">Program ücretleri, sunulan burs olanakları ve kampüse ulaşım gibi konularda en çok merak edilen soruları bu bölümde yanıtladık.</p>
          </div>
...
function FAQAccordion() {
  ...
  const faqs = [
    { q: "Özyeğin Üniversitesi Uygulamalı Bilimler Fakültesi bünyesinde hangi lisans programları yer almaktadır?", a: "Özyeğin Üniversitesi Uygulamalı Bilimler Fakültesi bünyesinde Gastronomi ve Mutfak Sanatları Lisans Programı ile Otel Yöneticiliği Lisans Programı yer almaktadır." },
    { q: "Gastronomi ve Mutfak Sanatları Programı'nın önce çıkan uluslararası iş birliği nedir?", a: "Gastronomi ve Mutfak Sanatları Lisans Programı, mutfak sanatları alanında dünyanın en köklü ve prestijli kurumu olan Le Cordon Bleu International iş birliği ile yürütülmektedir." },
    { q: "Otel Yöneticiliği Lisans Programı'nın Türkiyede'ki önemi ve eğitim yaklaşımı nedir?", a: "Otel Yöneticiliği Lisans Programı, ACPHA akreditasyonunu Avrupa'da ve Türkiye'de alan ilk ve tek programdır. Öğrenciler sektöre yenilikçi, girişimci ve yönetici adayları olarak hazırlanmaktadır." },
    { q: "Fakülte eğitimi verilen \"Fark Yaratan Ders İçerikleri\" nelerdir?", a: "Teorik derslerin yanı sıra, uygulama ağırlıklı eğitimler (L'Atelier Bleu gibi), 360 derece sanal tur simülasyonları, şarap biliminden dijital gastronomiye kadar geniş ve sektörel odaklı müfredat içerikleri sunulmaktadır." },
    { q: "Öğrencilerin zorunlu staj süreleri ne kadardır ve stajlar nerelerde yapılabilir?", a: "Öğrencilerimiz yurtiçi ve yurtdışında dünyanın önde gelen 5 yıldızlı otelleri, Michelin yıldızlı restoranlar ve kurumsal turizm şirketlerinde zorunlu yaz stajlarını tamamlamaktadırlar." },
    { 
      q: "Mezunların iş bulma oranları ve istihdam verileri nasıldır?", 
      a: "Sektörle iç içe eğitim modeli sayesinde her 2 öğrenciden 1’i henüz mezun olmadan iş hayatına adım atmaktadır. Mezuniyet sonrası ise ortalama 4 ay içinde kariyerlerine başlamaktadırlar. Mezunların %12’si yurt dışında çalışmakta, %7’si ise kendi işini kurarak girişimci olarak hayatına devam etmektedir. Mezunlar çoğunlukla dünya çapındaki beş yıldızlı otel zincirlerinde, Michelin yıldızlı restoranlarda, havayolu şirketlerinde ve kurumsal yiyecek-içecek firmalarında yönetici veya şef olarak görev almaktadır."
    }
  ];
