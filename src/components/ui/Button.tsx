    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-ozu-red text-white hover:bg-ozu-dark shadow-lg hover:shadow-xl hover:-translate-y-1": variant === "default",
            "border border-input bg-background hover:bg-accent hover:text-accent-foreground": variant === "outline",
            "hover:bg-accent hover:text-accent-foreground": variant === "ghost",
            "glass text-foreground hover:bg-white/20": variant === "glass",
